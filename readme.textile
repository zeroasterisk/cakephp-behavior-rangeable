...
save the @rangeable.php@ file into @./app/models/behaviors/rangeable.php@ in your application
...
class JobsController extends AppController {
	...
	// simple example
	function jobs_near_lat_lon($lat='38.113972', $lon='-85.837158') {
	...
	function jobs_near_zip($zip='40206') {
		$jobs = $this->Job->find('range', array(
			'conditions' => array(
				'Job.zip' => $zip,
				'Job.is_active' => 1, // whatever other conditions you like
	...
	function jobs_near_zip_at_least($zip='40206', $at_least=20) {
		$jobs = $this->Job->find('range', array(
			'conditions' => array(
				'Job.zip' => $zip,
				'Job.is_active' => 1, // whatever other conditions you like
	...
	function jobs_near_zip_sorted($zip='40206', $at_least=20) {
		$jobs = $this->Job->find('range', array(
			'conditions' => array(
				'Job.zip' => $zip,
				'Job.is_active' => 1, // whatever other conditions you like
